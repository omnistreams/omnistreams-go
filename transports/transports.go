...
func NewWebSocketServerTransport(w http.ResponseWriter, r *http.Request) (*gobwasTransport, error) {
...
func NewWebSocketClientTransport(ctx context.Context, uri string) (*gobwasTransport, error) {
	...
	if br != nil {
		return nil, errors.New("NewWebSocketClientTransport: Non nil br")
	}
